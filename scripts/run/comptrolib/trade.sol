...
contract Trades is Script { 
    ...
    function run() external { 
        ...
        pathAddresses[0] = 0x11920f139a3121c2836E01551D43F95B3c31159c; //weth
        pathAddresses[1] = 0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9; //usdt
 
        pathFees[0] = 3000; //fee
 
        uint256 outgoingAssetAmount = 1000000000000000;
